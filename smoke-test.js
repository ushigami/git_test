...
for (const file of ["data0.js", "data1.js", "data2.js", "data3.js", "comps-detail.js", "comps-formations.js"]) {
  new vm.Script(fs.readFileSync(file, "utf8"), { filename: file }).runInThisContext();
}
if (!Array.isArray(GUIDE_DATA) || GUIDE_DATA.length !== 21) throw new Error("expanded GUIDE_DATA must contain 20 existing + Carry Vortex");
