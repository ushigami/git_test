(function (root) {
  ...
  const tacticalTechs = [
    { unit: "Fortress", id: "anti-air-barrage", name: "Anti-Air Barrage", cost: 200, add: ["anti_air", "air_targeting"], threatTags: ["air"], grade: "A", note: "Air coverageにはこのTechが必要。", source: "https://mechabellum-companion.netlify.app/" },
    { unit: "Void Eye", id: "aerial-mode", name: "Aerial Mode", cost: 150, add: ["anti_air", "air_targeting", "mobility"], threatTags: ["air"], grade: "B", note: "Air攻撃可能になるが射程が低下。", source: "https://steamcommunity.com/app/669330/announcements/" },
    { unit: "Mustang", id: "missile-interceptor", name: "Missile Interceptor", cost: 200, add: ["missile_defense"], threatTags: ["missile", "artillery"], grade: "A", note: "迎撃中は通常攻撃を止める。", source: "https://wiki.mbxmas.com/mechanics/missile-interception/" },
    { unit: "Marksman", id: "aerial-specialization", name: "Aerial Specialization", cost: 250, add: ["anti_air"], threatTags: ["air"], grade: "A", matchups: { Wraith: "S", Phoenix: "A", Wasp: "A" }, note: "Airへの火力とtarget priorityを強化。", source: "https://mechabellum.wiki.gg/wiki/Marksman" },
    { unit: "Tarantula", id: "anti-aircraft-ammunition", name: "Anti-Aircraft Ammunition", cost: 300, add: ["anti_air", "air_targeting"], threatTags: ["air"], grade: "B", note: "Air攻撃可能になる。", source: "https://wiki.mbxmas.com/units/ground/tarantula/" },
    { unit: "Arclight", id: "anti-aircraft-ammunition", name: "Anti-Aircraft Ammunition", cost: 300, add: ["anti_air", "air_targeting"], threatTags: ["air"], grade: "B", matchups: { Wasp: "A" }, note: "Air攻撃可能。Wasp向けの用途が中心。", source: "https://mechabellum.wiki.gg/wiki/Arclight" },
    { unit: "Mountain", id: "anti-aircraft-ammunition", name: "Anti-Aircraft Ammunition", cost: 300, add: ["anti_air", "air_targeting"], threatTags: ["air"], grade: "A", note: "ATK低下と引き換えにAir攻撃可能。", source: "https://mechabellum.wiki.gg/wiki/Mountain" },
    { unit: "Sandworm", id: "anti-aerial", name: "Anti-Aerial", cost: 300, add: ["anti_air", "air_targeting"], threatTags: ["air"], grade: "B", note: "Air target軸を追加。", source: "https://mechamonarch.com/unit/sandworm/" },
    { unit: "Melting Point", id: "energy-diffraction", name: "Energy Diffraction", cost: 150, add: ["anti_formation"], threatTags: ["medium_pack", "sustained_pressure"], grade: "A", note: "beamを複数targetへ分割。Rangeとの併用負担に注意。", source: "https://wiki.mbxmas.com/guides/multimelter-fire-badger-defense/" },
    { unit: "Steel Ball", id: "mechanical-division", name: "Mechanical Division", cost: 300, add: ["screen", "target_saturation"], threatTags: ["single_target", "long_range"], grade: "B", note: "死亡後Crawlerでscreenを継続。", source: "https://wiki.mbxmas.com/units/ground/steel-ball/" },
    { unit: "Raiden", id: "ionization", name: "Ionization", cost: 200, add: ["anti_giant", "heavy_dps"], threatTags: ["giant", "tank"], grade: "A", note: "高HP target回答を追加するがmedium処理とtrade-off。", source: "https://wiki.mbxmas.com/units/air/raiden/" },
    { unit: "Phantom Ray", id: "sticky-oil-bomb", name: "Sticky Oil Bomb", cost: 100, add: ["control"], threatTags: ["chaff", "frontline_pressure"], grade: "B", note: "Fire sourceがある時にclear/controlへ変換。", requiresAny: ["Fire Badger", "Vulcan"], source: "https://wiki.mbxmas.com/units/air/phantom-ray/" },
    { unit: "Phantom Ray", id: "burst-mode", name: "Burst Mode", cost: 200, add: ["missile_breakthrough"], threatTags: ["missile_defense"], grade: "B", note: "anti-missile突破用。", source: "https://wiki.mbxmas.com/units/air/phantom-ray/" }
  ];
